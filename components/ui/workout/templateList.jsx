...
const TemplateList = ({
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={handleAddWorkout}>
      <View style={styles.headerContainer}>
        <View style={styles.routineHeader}>
          ...
          {/* <Text style={styles.exerciseCount}>
                            {Object.values(template.exercise_data).reduce((sum, group) => sum + group.exercises.length, 0)} Exercises
                        </Text> */}
          <TouchableOpacity
            ...
            {/* <TouchableOpacity
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <View style={styles.buttonContentWrapper}>
                                        <Ionicons name="add-circle" size={20} color="#000" style={{opacity:0}} />
                                        <Text style={[styles.buttonText, {opacity:0}]}> Log Workout</Text>
                                    </View>
                                </LinearGradient>
                            </MaskedView>
                        </TouchableOpacity> */}
