...
const HeaderComponent = ({
  ...
  //       try {
  //         const logo = await getToken("gym_logo");
  //         if (logo) {
  //           setGymLogo(logo);
  //         } else {
  //           console.warn("Gym logo not found");
  //         }
  //       } catch (error) {
  //         showToast({
  //           type: "error",
  //           title: "Error fetching gym logo",
  //           desc: error?.message || "",
  //         });
  //       }
  //     };
          ...
          <Animated.View style={[styles.topRow]}>
            <View style={styles.companyContainer}>
              ...
              <Text style={styles.logoText}>
                ...
                <Text style={styles.logoSecondPart}>bot Business</Text>
              </Text>
            </View>
            ...
            >
              ...
              >
                <Text style={{ color: "white" }}>{gymName}</Text>
