  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.sectionContainer}>
        <MaskedView
          maskElement={<Text style={styles.sectionTitle}>Fittbot User XP Quests</Text>}
        >
          <LinearGradient
            colors={['#030A15', '#0154A0']}
            start={{ x: 0, y: 0 }}
          ...
          >
            <Text style={[{ opacity: 0 }, styles.sectionTitle]}>
             Fittbot User XP Quests
            </Text>
          </LinearGradient>
        </MaskedView>
        <Text style={styles.sectionSubtitle}>Fittbot User's tasks to earn XP</Text>
