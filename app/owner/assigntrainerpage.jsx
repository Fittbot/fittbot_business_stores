...
import EnhancedPicker from "../../components/home/newbies/EnhancedPicker";
...
const AssignTrainerScreen = () => {
  ...
  const [assignmentType, setAssignmentType] = useState("trainer");
  const [selectedItem, setSelectedItem] = useState("");
  const [selectedTrainer, setSelectedTrainer] = useState("");
  const [assignmentMode, setAssignmentMode] = useState("trainer");
