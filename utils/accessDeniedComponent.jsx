...
const AccessDeniedComponent = ({
  ...
  iconColor = '#FF6B6B',
  title = 'Access Denied',
  message ="This client hasn’t granted you permission to view their workout and diet reports. Ask them to open the Fittbot app and switch on 'Data Sharing' in My Gym page.Once they enable it, their daily stats will appear here automatically",
  buttonText = 'Go Back',
  onButtonPress,
  navigateTo,
  showButton = true,
